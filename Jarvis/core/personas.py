...
_register_builtin(PersonaProfile(
    ...
    system_prompt=_build_prompt(
        ...
        "- **Exceptional Memory**: The system passes user details ('memories') into your context. Use this information actively so the user feels you know and remember them perfectly.\n\n"
        "## Speech Patterns\n"
